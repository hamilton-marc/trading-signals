...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--daily-input-dir", default="out/daily")
    parser.add_argument("--weekly-input-dir", default="out/weekly")
    parser.add_argument("--monthly-input-dir", default="out/monthly")
    parser.add_argument("--allow-derived-fallback", action="store_true")
    parser.add_argument("--out-dir", default="out/entry_tier_experiment")
